...
module.exports = {
  'base-angular': angular.module('instant-chat', ['ngAnimate', 'ngRoute', 'ngResource', 'ngEventEmitter', 'LocalStorageModule'])
    ...
    .directive('rotator',         require('./modules/instant-chat/directives/util/rotator/directive'))
    ...
    .factory('identity',        require('./modules/instant-chat/factories/identity/factory'))
