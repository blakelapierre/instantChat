...
module.exports = (function(log, emitter, signaler) {
  ...
  var signal;
  var $__2 = $traceurRuntime.assertObject(emitter()),
      fire = $__2.emit,
      on = $__2.on,
      off = $__2.off;
  ...
  function connectToSignal(server) {
    ...
    var rooms = $traceurRuntime.assertObject(signal).currentRooms;
    var peers = [],
        peersHash = {};
    ...
    socket.on('error', (function() {
      ...
      return ($__3 = log).error.apply($__3, $traceurRuntime.spread(['Failed to connect socket.io'], args));
    }));
    _.each({
      'connect': (function() {
